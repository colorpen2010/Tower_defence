...
class Poison_tower(tower_class.towernicsemus3_alhabethangerald3):
    ...
    def vistrel(self,enemy_coordinations=[500,500]):
        model.tec_wave.bullets.append(warehouse.Ammunition(0.4,'images/ammo/PoisonTower.png',self.visota, self.get_center()[0], self.get_center()[1] ,enemy_coordinations[0], enemy_coordinations[1], 2,2))
