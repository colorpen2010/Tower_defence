...
class Poison_tower(tower_class.towernicsemus3_alhabethangerald3):
    ...
    def vistrel(self,enemy_coordinations=[500,500]):
        model.bullets.append(warehouse.Ammunition(0.4,'images/ammo/PoisonTower.png',len(model.house), self.get_center()[0], self.get_center()[1] ,enemy_coordinations[0], enemy_coordinations[1], 2))
